...
def rnn_cell(module_name, hidden_dim, return_sequences=False):
  """Basic RNN Cell.
  ...
  # GRU
  if (module_name == 'gru'):
    rnn_cell = tf.keras.layers.GRU(units=hidden_dim, activation='tanh', return_sequences=return_sequences)
  # LSTM
